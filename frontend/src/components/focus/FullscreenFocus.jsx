  ...
  return (
    ...
    >
      ...
      <div style={{ 
        ...
        alignItems: 'center', zIndex: 1, marginBottom: '20px'
      }}>
        <motion.div 
      ...
      <div style={{ position: 'relative', zIndex: 1, margin: '20px 0' }}>
        <FocusTimer timer={timer} color={color} size={340} />
      </div>
      ...
      <div style={{ 
        ...
        gap: '40px', zIndex: 1, marginBottom: '20px'
      }}>
        <button 
        ...
        >
          {timer.isRunning ? <Pause size={32} /> : <Play size={32} fill="currentColor" />}
        </motion.button>
      ...
      <div style={{ 
        ...
        Press <span style={{ color: '#FFFFFF', padding: '2px 8px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', margin: '0 4px' }}>SPACE</span> to toggle, <span style={{ color: '#FFFFFF', padding: '2px 8px', background: 'rgba(255,255,255,0.05)', borderRadius: '4px', margin: '0 4px' }}>ESC</span> to exit
      </div>
    </motion.div>
  );
}
