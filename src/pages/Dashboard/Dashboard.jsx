...
import { studentProfile, mockResults, upcomingTasks, examCountdown } from '../../lib/mockData';

export default function Dashboard() {
  const { count: xpCount } = useCountUp(studentProfile.xp, 1200);
  const { count: streakCount } = useCountUp(studentProfile.streak, 800);
  const [ref] = useInView();
      ...
      <div style={{
        ...
        <motion.div {...stagger(4)}>
          <GlassCard elevated style={{ height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '24px' }}>
            <FocusScoreRing score={studentProfile.focusScore} />
          </GlassCard>
        </motion.div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
              ...
              <div style={{ display: 'flex', gap: '16px' }}>
                 ...
                 <div style={{ textAlign: 'right' }}>
                    ...
                    <div style={{ fontSize: '16px', fontWeight: 800 }}>{studentProfile.studyHoursThisWeek}h</div>
                 </div>
              </div>
            </div>
            <WeeklyChart />
